...
import { getProducts, deleteProduct, updateProduct } from '@/app/actions/admin-products';
                  ...
                  <tr key={product.id} className="hover:bg-neutral-100/50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-center hidden sm:table-cell">
                      <div className="flex items-center justify-center gap-1.5">
                        ...
                        {product.isFeatured && (
                          <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-secondary/20 text-yellow-700">
                            Destacado
                          </span>
                        )}
                      </div>
