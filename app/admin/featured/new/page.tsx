...
import { createFeaturedProduct } from '@/app/actions/admin-products';
...
export default function NewFeaturedPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      showToast('Producto destacado creado exitosamente');
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl font-bold text-primary">Nuevo Producto Destacado</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-5">
          ...
          <Button
            ...
            className="w-full"
          >
            {submitting ? 'Guardando...' : 'Crear Producto Destacado'}
          </Button>
        </div>
      </form>
    </div>
